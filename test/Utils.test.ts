...
describe('Utils', () => {
    ...
    describe('Logger', () => {
        it('should prefix all logs with [Win95]', () => {
            ...
            (Utils.Logger as any).enabled = true;
        ...
        it('should always show errors regardless of enabled flag', () => {
            ...
            (Utils.Logger as any).enabled = false;
    ...
    describe('escapeHTML', () => {
        ...
        it('should return empty string for non-string input', () => {
            expect(Utils.escapeHTML(null as any)).toBe('');
            expect(Utils.escapeHTML(undefined as any)).toBe('');
            expect(Utils.escapeHTML(42 as any)).toBe('');
        });
    ...
    describe('sanitizeHTML', () => {
        ...
        it('should return empty string for non-string input', () => {
            expect(Utils.sanitizeHTML(null as any)).toBe('');
            expect(Utils.sanitizeHTML(123 as any)).toBe('');
        });
    });
    ...
    describe('sanitizePath', () => {
        ...
        it('should return empty string for non-string input', () => {
            expect(Utils.sanitizePath(null as any)).toBe('');
        });
    });
    ...
    describe('randomChoice', () => {
        ...
        it('should return null for non-array input', () => {
            expect(Utils.randomChoice('not-array' as any)).toBeNull();
            expect(Utils.randomChoice(null as any)).toBeNull();
        });
    });
    ...
    describe('validateObject', () => {
        ...
        it('should return false for null/non-objects', () => {
            expect(Utils.validateObject(null as any, ['a'])).toBe(false);
            expect(Utils.validateObject('string' as any, ['a'])).toBe(false);
        });
    });
    ...
    describe('EventManager', () => {
        ...
        it('should remove all listeners at once', () => {
            const el = document.createElement('div');
            Utils.eventManager.add(el, 'click', vi.fn() as any);
            Utils.eventManager.add(el, 'mouseover', vi.fn() as any);
