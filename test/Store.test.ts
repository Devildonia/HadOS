...
import { Store, EventBus, createStateBridge } from '../js/core/EventBus';
...
describe('Store (Reactive State)', () => {
    ...
    describe('has / getAll', () => {
        ...
        it('should return a copy, not live reference', () => {
            ...
            const snap = Store.getAll() as any;
            snap.z = 'mutated';
    ...
    describe('State Bridge (Proxy)', () => {
        it('should create a proxy that reads from Store', () => {
            ...
            const proxy = createStateBridge() as any;
