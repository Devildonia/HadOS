...
import { showBSOD } from '../js/core/ErrorBoundary';
...
describe('ErrorBoundary — showBSOD()', () => {
    beforeEach(async () => {
        ...
        (VFS as any).__reset();
        await VFS.init();
        const mod = await import('../js/core/ErrorBoundary');
        (mod as any).__resetErrorBoundaryState();
    });
    ...
    describe('VFS logging', () => {
        ...
        it('appends multiple crashes to the log without overwriting', async () => {
