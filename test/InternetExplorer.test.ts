...
import '../js/apps/InternetExplorer';
...
describe('InternetExplorer', () => {
    ...
    describe('URL validation (security)', () => {
        ...
        beforeEach(() => {
            const proc = Kernel.launch('internet-explorer') as any;
    ...
    describe('navigation', () => {
        ...
        it('should update address bar on navigation', () => {
            ...
            const input = document.getElementById('ie-address-input') as HTMLInputElement;
