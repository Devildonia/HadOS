...
describe('PluginManagerApp UI', () => {
    ...
    it('should validate and install a new iframe plugin structure', () => {
        const app = new PluginManagerApp();
        const input = mockBody.querySelector('#pm-manifest-url') as HTMLInputElement;
        const installBtn = mockBody.querySelector('#pm-install-btn') as HTMLButtonElement;
    ...
    it('should enable uninstalling plugins from list', () => {
        ...
        const uninstallBtn = mockBody.querySelector('.pm-uninstall-btn') as HTMLButtonElement;
